...
public class BaseTest {
    ...
    public void initializeDriver(String browser){
        switch (browser){
            case "chrome":
                System.setProperty("webdriver.chrome.driver", "/Users/pailinritthikul/Desktop/Selenium/libs/chromedriver");
                driver = new ChromeDriver();
                break;
            case "firefox":
                System.setProperty("webdriver.gecko.driver", "/Users/pailinritthikul/Desktop/Selenium/libs/chromedriver");
